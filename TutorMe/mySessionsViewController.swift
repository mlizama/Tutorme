...
//  TutorMe
//
//  Created by Moises Lizama on 5/10/16.
//  Copyright © 2016 Moises Lizama. All rights reserved.
//

import UIKit

class mySessionsViewController: UIViewController, FSCalendarDelegate, FSCalendarDataSource
    ...
    func calendar(calendar: FSCalendar!, didSelectDate date: NSDate!) {
        ...
        let url: NSURL = NSURL(string: "http://default-environment.s4mivgjgvz.us-east-1.elasticbeanstalk.com/mysessionsforday.php")!
        let request:NSMutableURLRequest = NSMutableURLRequest(URL:url)
        var body = "";
        body += "id=";
        body += String(user_id);
                ...
                if let HTTPResponse = response as? NSHTTPURLResponse {
                    ...
                    if statusCode == 200 {
                        ...
                        if(!dataToReturn.isEmpty)
                        {
                            ...
                            for i in 0..<dataToReturn.count
                            {
                                var compose = "You have a session at "
